package ru.mirea.chernenkovais.fromlesson5;
...
import ru.mirea.chernenkovais.fromlesson5.databinding.ActivityMainBinding;
...
// Выполняется запрос к пользователь на получение необходимых разрешений
        ...
        magneticxTextView = findViewById(R.id.textViewX);
        magneticyTextView = findViewById(R.id.textViewY);
        magneticzTextView = findViewById(R.id.textViewZ);
    }
