package ru.mirea.chernenkovais.audiorecord;
...
import ru.mirea.chernenkovais.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String recordFilePath1 = "D://AndroidStudioProject//lesson5//audiorecord//src//main//res//raw";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordFilePath = (new File(getExternalFilesDir(Environment.DIRECTORY_MUSIC), "/test.3gp")).getAbsolutePath();
